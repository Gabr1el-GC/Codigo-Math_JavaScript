...
Diferentes, 'true'. */
const comparacao7 = comparacao1 ? 'Verdadeiro' : 'Falso'; // Realiza uma verificação na condição, e atribui um valor com base nesta condição. 
const comparacao8 = comparacao2 ? 'Verdadeiro' : 'Falso';
